...
const Tasks = () => {
    ...
    const activeTab = useFakeStore(state => state.activeTab);
    const setActiveTab = useFakeStore(state => state.setActiveTab);
    const activeMenuTab = useFakeStore(state => state.activeMenuTab);
    const setActiveMenuTab = useFakeStore(state => state.setActiveMenuTab);
    const menuTabs = useFakeStore(state => state.menuTabs);

    const addActivityToTask = useFakeStore(state => state.addActivityToTask);
            ...
            <div className='w-1/3 h-full flex flex-col items-start justify-start rounded-r-xl border-l border-[#C4CBD4]'>
                ...
                {selectedTarea && (
                    ...
                    <div className='w-full h-full flex flex-col items-start justify-start cursor-default'>
                        ...
                        <div className='w-full h-auto p-4 flex flex-col items-start justify-start gap-2 border-b border-[#C4CBD4]'>
                        ...
                        <div className='w-full h-auto p-4 flex flex-col items-start justify-start gap-5'>
                            ...
                            {activeTab === 'tareas' && (
                                <div className='w-full h-full max-h-[256px] overflow-y-auto flex flex-col items-start justify-start gap-3'>
