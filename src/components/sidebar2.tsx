                        ...
                        <div className='w-full h-auto flex flex-col items-start justify-start gap-2.5'>
                            ...
                            <Tooltip>
                                ...
                                <TooltipTrigger asChild>
                                    ...
                                    <div className={`w-full min-h-9 max-w-[300px] flex flex-row items-center justify-start gap-2 p-2 rounded-md text-black ${selectedProject === '/' ? 'bg-black text-white' : 'hover:bg-black hover:text-white'} ease-in-out duration-200 cursor-pointer`} onClick={() => handleProjectClick('/')}>
                            ...
                            {projects.map(project => (
                                <Tooltip key={project.title}>
                                    ...
                                    <TooltipTrigger asChild>
                                        ...
                                        <div className={`w-full min-h-9 max-w-[300px] flex flex-row items-center justify-start gap-2 p-2 rounded-md text-black ${selectedProject === project.title ? 'bg-black text-white' : 'hover:bg-black hover:text-white'} ease-in-out duration-200 cursor-pointer`} onClick={() => handleProjectClick(project.title)}>
